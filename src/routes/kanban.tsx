...
import { KanbanScreen } from '@/screens/kanban/kanban-screen'
...
export const Route = createFileRoute('/kanban')({
  ...
  errorComponent: function KanbanError({ error }) {
    return (
      <div className="flex h-full flex-col items-center justify-center bg-primary-50 p-6 text-center">
        <h2 className="mb-3 text-xl font-semibold text-primary-900">Failed to Load Kanban</h2>
  ...
  pendingComponent: function KanbanPending() {
    return (
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-primary-500">Loading Kanban...</p>
        </div>
      </div>
    )
  },
